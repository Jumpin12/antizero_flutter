                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              int acceptedMemLength =
                                  getAcceptedMemberLength(plan.member);
                              ...
                              MemberStatus status =
                                  checkStatus(plan.member, context);
                              GlobalKey keyK;
                              Uint8List bytes;
                              return WidgetToImage(builder: (key) {
                                ...
                                return HomeCard(
                                  ...
                                  upperLeft: Positioned(
                                    top: 0,
                                    left: 0,
                                    child: DateTimeCard(
                                      label: 'Date',
                                      textAlign: Alignment.centerLeft,
                                      iconAlign: Alignment.bottomLeft,
                                  ...
                                  upperRight: Positioned(
                                    top: 0,
                                    right: 0,
                                    child: DateTimeCard(
                                      label: 'Timings',
                                      textAlign: Alignment.centerRight,
                                      iconAlign: Alignment.bottomRight,
                                      isMultiDay: false,
                                  ...
                                  //   spotsLeft: spotLeft,
                                  // ),
                                  lowerLeft: ConnectionMemberCard(
                                    memberIds: plan.member,
                                  ),
                                  jumpInButton: AcceptPlanBtn(
                                      member: plan.member,
                                      public: plan.public,
                                      plan: plan,
