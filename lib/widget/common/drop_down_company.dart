...
class CustomDropDownCompany extends StatelessWidget {
  final FocusNode focus;
  final String label;
  final String hint;
  final List<DropdownMenuItem<Company>> list;
  final Function(Company newSelection) onChanged;
  final Company selectedValue;
  final Color borderColor;

  const CustomDropDownCompany({
    Key key,
    this.focus,
    this.label,
    this.hint,
